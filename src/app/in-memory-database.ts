...
export class InMemoryDatabase implements InMemoryDbService {
    ...
    createDb() {
        ...
        { id: 3, name: 'Lazer', description: 'Cinema, praia, viagem'},
        { id: 4, name: 'Salário', description: 'Recebimento de Salário'},
        { id: 5, name: 'Freelas', description: 'Projetos de freelancer'},
        { id: 6, name: 'Alimentação', description: 'Café da manha, almoço'}
    ];
